...
@PostMapping("/insert")
public BaseRespones
<Integer> insert${UpperTable}( @RequestBody ${UpperTable} ${TableName}){//insertPath
    ...
    <Integer> update${UpperTable}(@Nullable @RequestBody ${UpperTable} ${TableName}){
        ...
        <Integer> delet${UpperTable}(${KeyType} ${KeyName}){
            ...
            public BaseRespones
            <List
            < ${UpperTable}> > selectListOf(Integer start, Integer size){//selectAll Data
