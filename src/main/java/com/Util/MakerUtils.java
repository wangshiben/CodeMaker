...
public class MakerUtils {
    ...
    public static void  MakeCode(String keyName, String tableName, List<Column> columns, String package_name, String basename, Properties properties, Logger log) throws IOException, TemplateException {
       MakeCode(keyName,tableName, columns, package_name,basename, properties,log,null);
    }


    public static void  MakeCode(String keyName, String tableName, List<Column> columns, String package_name, String basename, Properties properties, Logger log,String sessionID) throws IOException, TemplateException {
    ...
    public static void MakeZIP(Properties properties, OutputStream outputStream) throws IOException {//生成ZIP包,前提:未改变文件位置
       MakeZIP(properties,outputStream,null);
    }
    //生成ZIP文件
    public static void MakeZIP(Properties properties, OutputStream outputStream,String sessionID) throws IOException {//生成ZIP包,前提:未改变文件位置
